...
/**
 * Created by nickisverygood on 3/4/2016.
 */
/*
...
public class ExampleVisualOdometryMonocularPlane {
    SimpleImageSequence<ImageUInt8> mySimpleImageSequence;

    public ExampleVisualOdometryMonocularPlane(ImageStreamSequence<ImageUInt8> input) {
