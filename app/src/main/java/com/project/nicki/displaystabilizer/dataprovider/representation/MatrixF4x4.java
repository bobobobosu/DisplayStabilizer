package com.project.nicki.displaystabilizer.dataprovider.representation;
...
public class MatrixF4x4 {
    ...
    /**
     * Set whether the internal buffer is col major by passing true, or false for a row major matrix. The matrix is column
     * major by default.
     *
     * @param colMajor
     */
